...
export type Category = { id: number; parent_id: number | null; user_id: string | null; name_zh: string; name_en: string; sort_order: number; created_at: string; updated_at: string };
