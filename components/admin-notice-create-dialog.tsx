    ...
    {open ? <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center sm:p-6">
      ...
      <div role="dialog" aria-modal="true" aria-labelledby="notice-dialog-title" className="relative max-h-[92vh] w-full overflow-y-auto rounded-t-3xl bg-white p-5 shadow-2xl sm:max-w-xl sm:rounded-2xl sm:p-7">
        ...
        <form action={createNotice} className="space-y-5">
          ...
          <div className="space-y-2"><Label htmlFor="notice-content-en">英文内容</Label><textarea id="notice-content-en" name="contentEn" required maxLength={5000} rows={4} className="w-full resize-y rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm outline-none placeholder:text-slate-400 focus:ring-2 focus:ring-emerald-500/30" placeholder="Enter the English content" /></div>
