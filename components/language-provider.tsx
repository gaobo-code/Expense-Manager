...
const messages = {
  en: {
    ...
    deleteCustomerConfirm: "This customer can only be deleted when it is not used by any transaction.",
    confirmDeleteCustomer: "Delete",
    customerInUse: "This customer cannot be deleted because it is used by a transaction.",
    customerDeleteFailedTitle: "Unable to delete customer",
    customerDeleteFailed: "The customer could not be deleted. Please try again.",
    ...
    confirmDeleteCategory: "Delete",
    deleteCategoryConfirm: "Delete this category? Top-level categories also delete their unassigned subcategories.",
    categoryInUse: "This category cannot be deleted because it is used by a transaction.",
    categoryDeleteFailedTitle: "Unable to delete category",
    categoryDeleteFailed: "The category could not be deleted. Please try again.",
    ...
    amountEffect: "Amount effect",
    amountIncrease: "Increase amount",
    amountDecrease: "Decrease amount",
    amountEffectDescription: "Controls whether transactions in this category add to or subtract from totals.",
    cancel: "Cancel",
    close: "Close",
    ...
    chooseVideoPlatform: "Choose a video platform",
    chooseVideoPlatformDescription: "Select where you would like to watch this alert.",
  ...
  zh: {
    ...
    editCustomer: "编辑客户",
    deleteCustomer: "删除客户",
    deletingCustomer: "正在删除…",
    deleteCustomerTitle: "确定删除这个客户？",
    deleteCustomerConfirm: "只有尚未被任何交易使用的客户才能删除。",
    confirmDeleteCustomer: "确认删除",
    customerInUse: "该客户已被交易使用，无法删除。",
    customerDeleteFailedTitle: "无法删除客户",
    customerDeleteFailed: "客户删除失败，请稍后重试。",
    ...
    deleteCategoryTitle: "确定删除这个类别？",
    confirmDeleteCategory: "确认删除",
    deleteCategoryConfirm: "确定删除这个类别吗？删除一级类别时，其下尚未绑定交易的子类别也会一并删除。",
    categoryInUse: "该类别已被交易使用，无法删除。",
    categoryDeleteFailedTitle: "无法删除类别",
    categoryDeleteFailed: "类别删除失败，请稍后重试。",
    ...
    amountIncrease: "金额增加",
    amountDecrease: "金额减少",
    amountEffectDescription: "决定该类别的交易在统计时增加还是减少原有金额。",
    cancel: "取消",
    close: "关闭",
    saveChanges: "保存修改",
    confirmAdd: "确认添加",
    ...
    chooseVideoPlatform: "选择视频平台",
    chooseVideoPlatformDescription: "请选择观看这条提示的平台。",
